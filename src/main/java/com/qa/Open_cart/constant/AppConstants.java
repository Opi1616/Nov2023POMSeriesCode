package com.qa.Open_cart.constant;
...
public class AppConstants {
	...
	public static final String ACCOUNNT_PAGE_TITLE_VALUE = "My Account";
	public static final String ACCOUNNT_PAGE_URL_FRACTION_VALUE = "route=account/account";
	public static final int ACCOUNNT_PAGE_URL_HEADERS_COUNT = 4;
